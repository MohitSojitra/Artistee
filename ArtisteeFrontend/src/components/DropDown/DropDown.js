...
import {filterType, generes} from '../../utils/config'
    ...
    >
      <Box className={classes.dropDownTitle}>
        <Typography variant="h3" className={classes.filterBygenre} gutterBottom>
          {filter.type === filterType.GENERE ? value : `filter by genere`}
        </Typography>
        <ArrowForwardIosIcon
          style={{
              ...
              return (
                <Box
                  ...
                  onClick={() => {
                    ...
                    setFilter({
                      type:
                        genere === filterType.ALL
                          ? filterType.ALL
                          : filterType.GENERE,
                      keyWord: genere === filterType.ALL ? '' : genere,
                    })
